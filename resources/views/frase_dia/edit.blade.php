...
<x-app-layout>
    ...
    <div class="py-12 flex justify-center h-full">
        ...
        <div class="md:w-3/4 p-10 bg-white rounded-lg shadow-xl mt-10 md:mt-0 ">
            ...
            <form action="{{ route('frases.update', $frase->id) }}" method="POST"  novalidate>
                @csrf
                @method('PUT')
                ...
                <div class="flex flex-wrap">
                    ...
                    <div class="w-full px-4">
                        ...
                        <div class="mb-5">
                            ...
                            <x-text-input id="frase" class="p-3 w-full mb-4" type="text" name="frase" value="{{ old('frase', $frase->frase) }}" required />
