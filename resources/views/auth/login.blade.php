    ...
    <form method="POST" action="{{ route('login') }}" novalidate>
        ...
        <div class="block mt-4">
            <label for="remember_me" class="inline-flex items-center">
                <input id="remember_me" type="checkbox" class="rounded dark:bg-gray-900 border-gray-300 dark:border-gray-700 text-[#dd6b10] shadow-sm focus:ring-[#dd6b10] dark:focus:ring-[#dd6b10] dark:focus:ring-offset-gray-800" name="remember">
