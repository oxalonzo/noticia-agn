...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  {{-- <header id="header" class="header d-flex align-items-center ">
    <div class="container position-relative d-flex align-items-center justify-content-between">
      ...
      <a href="#" class="logo d-flex align-items-center me-auto me-xl-0">
        ...
        <img src="{{asset('assets/img/agnlogo.jpg') }}" alt="logo agn"> 
  ...
  <main class="main">
    ...
    <section id="noticias" class="hero section">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="py-2 px-0 flex  justify-end">
  ...
  <!-- Bloque original -->
  <div class="col-lg-12 ">
    <div class="badge-wrapper mb-5">
      <div class="d-inline-flex align-items-center rounded-pill border border-accent-light">
        <div class="icon-circle me-2">
          <i class="bi bi-bell"></i>
        </div>
        <span class="badge-text me-3">Donde la historia se guarda, vive y habla.</span>
      </div>
    </div>
    <h1 class="hero-title mb-5"><span class="titulo-agn">AGN</span> al Día</h1>
  </div>
  ...
  <!-- Bloque destacado estilo swiper-slide -->
  @if($destacada)
      

<div class="col-lg-12 mt-4">
  <a href="{{ route('noticia.destacada', $destacada->id) }} " class="block w-full h-full group">
    <div class="flex flex-row w-full bg-white rounded-md shadow-md overflow-hidden">
      ...
      <div class="w-1/2 p-4 flex flex-col justify-center">
        <h3 class="text-lg font-bold mb-2 text-[#dd6b10]"> {{ $destacada->titulo_noticia_portada_destacada }} </h3>
  ...
  @endif
        ...
        <section id="testimonials" class="testimonials section-noticias">

     

      <div class="container-noticia" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="testimonials-slider swiper init-swiper">
          ...
          <div class="swiper-slide ">
            <a href="{{ route('noticias.show', $noticia->id) }}" class="block w-full h-full group ">
              <div class="flex flex-row w-full bg-white rounded-md shadow-md overflow-hidden ">
                ...
                <!-- Texto -->
                <div class="w-1/2 p-4 flex flex-col justify-center">
                  <h3 class="text-lg font-bold mb-2 text-[#dd6b10]">{{ $noticia->titulo_noticia_portada }}</h3>
                  <p class="text-sm text-gray-700">
                    <i class="bi bi-quote quote-icon"></i>
  ...
  {{-- <footer id="footer" class="footer light-background">
    ...
    <div class="container copyright text-center mt-4">
      <p>© <span>Derechos reservados</span> <strong class="px-1 sitename">AGN</strong> <span>{{ date('Y') }}</span></p>
